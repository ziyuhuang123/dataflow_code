...
class MatrixBlockApp(QMainWindow):
    ...
    def initUI(self):
        ...
        control_layout.addWidget(QLabel('M: (Number of rows in Matrix A and C)(for example 512)'))
        control_layout.addWidget(self.m_input)
        control_layout.addWidget(QLabel('N: (Number of columns in Matrix B and C)(for example 512)'))
        control_layout.addWidget(self.n_input)
        control_layout.addWidget(QLabel('K: (Number of columns in Matrix A and rows in Matrix B)(for example 128)'))
        control_layout.addWidget(self.k_input)
        control_layout.addWidget(QLabel('Cache Size: (Maximum number of blocks in cache)(for example 4)'))
