...
def generate_and_evaluate_unique_compute_orders(batch_size=10000, output_file='unique_compute_orders.pkl'):
    ...
    optimal_orders = []
    min_access = 0.45  # Set the initial min access to 0.4 to filter only better results
